package dev.alexandreoliveira.gft.rabobank.travels.flights.configurations;
...
public class KafkaConfiguration {
    ...
    public NewTopic lockHotels() {
        return TopicBuilder.name(KAFKA_TOPIC_TRAVEL_FLIGHTS_LOCK_LISTEN)
                .partitions(1)
                .replicas(1)
                .build();
    }
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        String trustedPackages = String.join(
                ", ",
                SeatsReservationsSubscriptionMessage.class.getPackageName()
        );
