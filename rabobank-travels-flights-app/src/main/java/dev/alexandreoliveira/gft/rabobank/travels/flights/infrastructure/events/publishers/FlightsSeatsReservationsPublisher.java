...
public class FlightsSeatsReservationsPublisher implements SeatsReservationsPublisher {
    ...
    public void publishLockSeatEvents(UUID registrationId, List<? extends SeatModel> seats) {
        ...
        headers.add(new RecordHeader("__TypeId__", "dev.alexandreoliveira.gft.rabobank.travels.infrastructure.entrypoints.subscriptions.kafka.reservations.locks.flights.ReservationsLocksFlightsSubscriptionMessage".getBytes()));
