package dev.alexandreoliveira.gft.rabobank.travels.flights.infrastructure.dataproviders.postgresql.entites;
...
public class FlightEntity extends BaseEntity implements FlightModel {
    ...
    @OneToMany(fetch = FetchType.EAGER, mappedBy = "flight", cascade = CascadeType.ALL, targetEntity = SeatEntity.class)
