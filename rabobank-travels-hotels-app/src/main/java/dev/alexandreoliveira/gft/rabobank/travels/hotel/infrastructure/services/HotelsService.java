...
import dev.alexandreoliveira.gft.rabobank.travels.hotel.core.usecases.hotels.create.HotelsCreateUseCase;
import dev.alexandreoliveira.gft.rabobank.travels.hotel.core.usecases.hotels.index.HotelsIndexUseCase;
import dev.alexandreoliveira.gft.rabobank.travels.hotel.core.usecases.rooms.create.RoomsCreateUseCase;
...
import dev.alexandreoliveira.gft.rabobank.travels.hotel.infrastructure.dateproviders.postgresql.repositories.HotelsRepository;
...
import dev.alexandreoliveira.gft.rabobank.travels.hotel.infrastructure.entrypoints.rest.hotels.create.HotelsCreateControllerRequest;
import dev.alexandreoliveira.gft.rabobank.travels.hotel.infrastructure.entrypoints.rest.hotels.create.HotelsCreateControllerResponse;
import dev.alexandreoliveira.gft.rabobank.travels.hotel.infrastructure.entrypoints.rest.hotels.index.HotelsIntexControllerRequest;
import dev.alexandreoliveira.gft.rabobank.travels.hotel.infrastructure.entrypoints.rest.hotels.index.HotelsIntexControllerResponse;
...
public class HotelsService extends BaseService {
    ...
    public HotelsCreateControllerResponse create(HotelsCreateControllerRequest request) {
        ...
        hasErrors(output, "Erro ao criar um novo hotel");
        ...
        request.rooms().forEach(room -> {
            ...
            hasErrors(outputRoom, "Error to create rooms for hotel.");
        });
