package dev.alexandreoliveira.gft.rabobank.travels.hotel.infrastructure.dateproviders.postgresql.repositories;

import dev.alexandreoliveira.gft.rabobank.travels.hotel.core.models.RoomModel;
import dev.alexandreoliveira.gft.rabobank.travels.hotel.core.usecases.rooms.create.RoomsCreateRepository;
import dev.alexandreoliveira.gft.rabobank.travels.hotel.core.usecases.rooms.lock.RoomsLockRepository;
import dev.alexandreoliveira.gft.rabobank.travels.hotel.core.usecases.rooms.unlock.RoomsUnlockRepository;
import dev.alexandreoliveira.gft.rabobank.travels.hotel.infrastructure.dateproviders.exceptions.DataProvidersException;
...
public class RoomsRepository implements RoomsLockRepository, RoomsUnlockRepository, RoomsCreateRepository {
    ...
    public RoomModel lock(UUID roomId, UUID hotelId, UUID reservationId, Boolean available) {
        ...
        if (!roomEntity.getHotel().getId().equals(hotelId)) {
            throw new DataProvidersException("Room not found for this hotel.");
        }
