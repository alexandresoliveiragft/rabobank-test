...
public class HotelsRoomsReservationsPublisher implements RoomsLockReservationPublisher {
    ...
    public void notifyForReservationLockRooms(RoomModel model) {
        ...
        headers.add(new RecordHeader("__TypeId__", "dev.alexandreoliveira.gft.rabobank.travels.infrastructure.entrypoints.subscriptions.kafka.reservations.locks.hotels.ReservationsLocksHotelsSubscriptionMessage".getBytes()));
