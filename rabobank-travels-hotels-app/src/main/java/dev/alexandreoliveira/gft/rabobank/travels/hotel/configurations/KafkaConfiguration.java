package dev.alexandreoliveira.gft.rabobank.travels.hotel.configurations;
...
public class KafkaConfiguration {
    ...
    public static final String KAFKA_TOPIC_LOCK_HOTELS = "LOCK_HOTELS";
    ...
    public NewTopic lockHotels() {
        return TopicBuilder.name(KAFKA_TOPIC_TRAVEL_HOTELS_LOCK_LISTEN)
                .partitions(1)
                .replicas(1)
                .build();
    }
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        String trustedPackages = String.join(
                ", ",
                RoomsLockSubscriptionMessage.class.getPackageName()
        );
