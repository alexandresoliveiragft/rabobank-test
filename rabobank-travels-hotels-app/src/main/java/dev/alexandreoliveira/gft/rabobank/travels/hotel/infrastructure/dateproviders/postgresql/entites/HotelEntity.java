package dev.alexandreoliveira.gft.rabobank.travels.hotel.infrastructure.dateproviders.postgresql.entites;
...
public class HotelEntity extends BaseEntity implements HotelModel {
    ...
    @OneToMany(fetch = FetchType.EAGER, mappedBy = "hotel", cascade = CascadeType.ALL, targetEntity = RoomEntity.class)
