...
public class ReservationsLocksPublishersImpl implements ReservationsCreatePublisher {
    ...
    public void lockHotels(UUID reservationId, HotelModel hotel) {
        ...
        headers.add(new RecordHeader("__TypeId__", "dev.alexandreoliveira.gft.rabobank.travels.hotel.infrastructure.entrypoints.subscriptions.rooms.lock.RoomsLockSubscriptionMessage".getBytes()));
    ...
    public void lockFlights(UUID reservationId, List<? extends FlightModel> flights) {
        ...
        List <Header> headers = new ArrayList<>();
        headers.add(new RecordHeader("__TypeId__", "dev.alexandreoliveira.gft.rabobank.travels.flights.infrastructure.entrypoints.subscriptions.seats.reservations.SeatsReservationsSubscriptionMessage".getBytes()));
