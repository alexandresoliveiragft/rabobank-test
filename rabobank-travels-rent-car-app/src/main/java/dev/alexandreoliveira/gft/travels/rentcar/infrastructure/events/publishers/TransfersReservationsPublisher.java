...
public class TransfersReservationsPublisher implements TransfersLockReservationPublisher {
    ...
    public void notify(TransferModel transferModel) {
        ...
        headers.add(new RecordHeader("__TypeId__", "dev.alexandreoliveira.gft.rabobank.travels.infrastructure.entrypoints.subscriptions.kafka.reservations.locks.transfers.ReservationsLocksTransfersSubscriptionMessage".getBytes()));
